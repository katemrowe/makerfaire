			...
			case 'add_note' :
				...
				if ( rgpost( 'gentry_email_notes_to' ) ) {
					...
					if ( $result ) {
						...
						GFCommon::log_debug( 'GFEntryDetail::lead_detail_page(): The mail message was passed off to WordPress for processing, but WordPress was unable to send the message.' );
					}
				}
				break;
