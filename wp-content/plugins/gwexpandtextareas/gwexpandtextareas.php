...
class GWExpandTextareas extends GWPerk {
    ...
    public function field_settings_js() {
        ...
        .gwp-expand a { background-color: #f7f7f7; font-size: 11px;
            color: #999 !important; cursor: pointer; margin: -1px 0 0 5px; padding: 5px 10px;
        ...
        jQuery(document).ready(function($){
            var applyTo = gwpAllTextareas ? 'li.field_setting textarea' : gwpDefaultTextareas;
        ...
        function loadTextareaModal(textareaId) {
            ...
            jQuery('#TB_ajaxContent').attr('style', 'width: 800px; height: 450px !important;');

            tb_show(field.label + ' : Field ID ' + field.id + ' : ' + labelText, '#TB_inline?width=800&amp;inlineId=textarea_modal_container', '');
        ...
        function insertTextareaValue() {
            ...
            gwpActiveTextarea.val(value).trigger('keyup');
            gwsTbRemove();
        }
