	...
	function column_default( $item, $column_name ){
		switch( $column_name ){
			case 'shortcode':
				...
				break;
			case 'functions':
				return '<button class="button wpDataTablesDuplicateTable" data-table_id="'.$item['id'].'" data-table_name="'.$item['title'].'"><div class="dashicons dashicons-admin-page"></div>'.__('Duplicate','wpdatatables').'</button>';
				break;
			case 'id':
			case 'title':
			case 'table_type':
