...
class WPDataTable {
    ...
    public function getCell( $dataColumnIndex, $rowKey ) {
        ...
        return $this->_dataRows[$rowKey]->getCell( $dataColumnIndex );
    }
    ...
    private function _renderWithJSAndStyles() {
        ...
        if(true || $this->_firstOnPage && $this->scriptsEnabled) {
			...
			if($this->isEditable()){
		        wp_register_script('jquery-fileupload-iframe',WDT_JS_PATH.'fileupload/jquery.iframe-transport.js',array('jquery'));
		        wp_register_script('jquery-fileupload',WDT_JS_PATH.'fileupload/jquery.fileupload.js',array('jquery'));
    ...
    public function renderChart( $divId ) {
        ...
        foreach($this->getDataRows() as $row) {
            ...
            foreach($this->_chartSeriesArr as $dataColumnIndex){
                ...
                if($this->getColumn($dataColumnIndex)->getDataType() != 'string') {
					if($this->getColumn($dataColumnIndex)->getDataType() == 'date'){
