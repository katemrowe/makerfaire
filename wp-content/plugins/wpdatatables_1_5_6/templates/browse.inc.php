...
<div class="wrap">
	...
	<p><i><?php _e('Please refer to','wpdatatables');?> <a href="http://wpdatatables.com/wpDataTables_documentation.pdf"><?php _e('wpDataTables documentation','wpdatatables');?></a> <?php _e('if you have some questions or problems with the plugin.','wpdatatables'); ?></i></p>    <h2>wpDataTables <a href="admin.php?page=wpdatatables-addnew" class="add-new-h2"><?php _e('Add new','wpdatatables');?></a></h2>
