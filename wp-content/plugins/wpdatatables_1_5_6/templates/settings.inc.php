					...
					<div class="postbox">
					    ...
					    <div class="inside">
							...
							<tbody>
							    ...
							    <tr>
								<th scope="row">
								    <label for="wpRenderCharts"><?php _e('Render charts','wpdatatables'); ?></label>
								</th>
								<td>
								    <select name="wpRenderCharts" id="wpRenderCharts">
									<option value="above" <?php if ($wpRenderCharts == 'above') { ?>selected="selected"<?php } ?> ><?php _e('Above the table','wpdatatables'); ?></option>
									<option value="below" <?php if ($wpRenderCharts == 'below') { ?>selected="selected"<?php } ?> ><?php _e('Below the table','wpdatatables'); ?></option>
								    </select>
								    <span class="description"><?php _e('Choose where you would like to render the charts','wpdatatables'); ?>.</span>
								</td>
							    </tr>
							    <tr>
								<th scope="row">
