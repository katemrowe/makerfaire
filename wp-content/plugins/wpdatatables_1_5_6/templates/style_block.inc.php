...
.wpDataTablesWrapper table.wpDataTable thead th {
	color: <?php echo $wdtFontColorSettings['wdtHeaderFontColor'] ?>;
}
...
.wpDataTablesWrapper table.wpDataTable thead th.sorting_asc:after {
	border-bottom-color: <?php echo $wdtFontColorSettings['wdtHeaderFontColor'] ?>;
}

.wpDataTablesWrapper table.wpDataTable thead th.sorting_desc:after {
	border-top-color: <?php echo $wdtFontColorSettings['wdtHeaderFontColor'] ?>;
}
...
.wpDataTablesWrapper table.wpDataTable thead th.sorting:hover {
	background-color: <?php echo $wdtFontColorSettings['wdtHeaderActiveColor'] ?>;
}
<?php } ?>
...
.wpDataTablesWrapper table.wpDataTable td {
	background-color: <?php echo $wdtFontColorSettings['wdtTableInnerBorderColor'] ?>;
}
<?php } ?>
...
.wpDataTablesWrapper table.wpDataTable tr:last-child td {
	border-bottom-color: <?php echo $wdtFontColorSettings['wdtTableOuterBorderColor'] ?>;
}

.wpDataTablesWrapper table.wpDataTable tr td:first-child {
	border-left-color: <?php echo $wdtFontColorSettings['wdtTableOuterBorderColor'] ?>;
}

.wpDataTablesWrapper table.wpDataTable tr td:last-child {
	border-right-color: <?php echo $wdtFontColorSettings['wdtTableOuterBorderColor'] ?>;
}
<?php } ?>
...
.wpDataTablesWrapper table.wpDataTable tr.odd td {
	background-color: <?php echo $wdtFontColorSettings['wdtOddRowColor'] ?>;
}
<?php } ?>
...
.wpDataTablesWrapper table.wpDataTable tr.odd td.sorting_1 {
	background-color: <?php echo $wdtFontColorSettings['wdtActiveOddCellColor'] ?>;
}
<?php } ?>
...
.wpDataTablesWrapper table.wpDataTable tr.even td.sorting_1 {
	background-color: <?php echo $wdtFontColorSettings['wdtActiveEvenCellColor'] ?>;
}
<?php } ?>
