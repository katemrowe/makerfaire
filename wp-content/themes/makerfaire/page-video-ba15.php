						...
						<div class="modal-body">
							<script>
								jQuery('#myModal34').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=hVHPsIiBVpk&index=24&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal2').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=Xgwqy2lJ3_g&index=33&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal3').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=81kJuLI94O0&index=32&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal4').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=fxHyAgybbZs&index=31&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal5').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=H3sWm-OOjYk&index=30&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal6').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=eJxZtn2gdT0&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us&index=29" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal7').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=rLC8G7fM9PA&index=28&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal8').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=JGBzHCmAPI0&index=27&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal9').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=gFCPnohdz-c&index=26&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal10').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=bHa97MYju9I&index=25&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal11').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=hVHPsIiBVpk&index=10&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal12').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=2HW1YUT1CMw&index=23&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal13').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=BaJczW6HgUU&index=22kal&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal14').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=b2fRyiC8JKg&index=21&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal15').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=85PVwyqkOdk&index=20&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal16').on('show', function () {
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=0bFHzlEYdAg&index=19&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal17').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=19hsorBt59NE&index=16&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal18').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=2DxGPWJBB_M&index=17&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal19').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=-Z6qYhwIN6U&index=16&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal20').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=inJNN6WibxM&index=15&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal21').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=0UVn3QaI3zc&index=14&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal22').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=ByOAkOnS7O4&index=13&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal23').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=njlz6NfXxjM&index=12&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal24').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=HyWn4_22cN8&index=11&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal25').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=4enXl57BjG8&index=10&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal26').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=fgquWO_D-_8&index=25&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal27').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=2dcPd_H9gnQ&index=8&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal28').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=jOUALurj5P4&index=7&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal29').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=Zhu4JWEMlwg&index=6&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal30').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=ER6FJgY-iFI&index=5&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal31').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=Kw37VfXIbCg&index=2&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal32').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=eGMLwIjoWog&index=1&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal33').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=NfmZjG3LoIg&index=0&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
				...
				<div class="row" style="margin-bottom: 30px;">
					...
					<!-- <div id="myModal32" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal32').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=eGMLwIjoWog&index=2&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
								jQuery('#myModal32').on('hide', function () {
								 jQuery('div.modal-body').html('');
								});
					...
					<!-- <div id="myModal33" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					 ...
					 --><!-- Video Modal -->
						...
						<div class="modal-body">
							<script>
								jQuery('#myModal33').on('show', function () { 
								 jQuery('div.modal-body').html('<iframe src="https://www.youtube.com/embed/watch?v=NfmZjG3LoIg&index=1&list=PLwhkA66li5vC06gyQNvo6I6nd9AXjN5us" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');  
								});
								jQuery('#myModa33').on('hide', function () {
								 jQuery('div.modal-body').html('');
								});
