<?php
	...
	if ( ! class_exists( 'Make_List_Tables_Entries_Search' ) && is_admin() ) {
		require_once( 'includes/class.entries-search.php' );

		// Instantiate our listed tables of all blog content.
		$GLOBALS['make_list_table_entries_search'] = new Make_List_Tables_Entries_Search();
