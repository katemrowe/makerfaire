<?php
	 ...
	 */
	class Make_List_Tables_Entries_Search {
		...
		public $submenu_data = array(
			'parent_slug' => 'admin.php?page=gf_edit_forms',
			'page_title'  => 'Entries Search',
			'menu_title'  => 'Entries Search',
			'menu_slug'   => 'entries search',
			'page_url'	  => 'edit.php?page=entries_search',
		);
