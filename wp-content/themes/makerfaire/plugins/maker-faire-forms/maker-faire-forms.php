...
FROM wp_posts
WHERE 1=1
AND wp_posts.post_type = 'mf_form'
	...
	public function meta_box( $post, $args ) {
		...
		<?php } elseif ( $args['id'] == 'mf_logs' ) {
			...
			<table style="width:100%">
				<tr>
					<td style="width:210px;" valign="top"><img src="<?php //echo esc_url( get_resized_remote_image_url( $photo, 200, 200 ) ); ?>" width="200" height="200" /></td>
					<td valign="top">
...
**/
	...
	* =====================================================================*/
	...
	/*
	* Sync all MakerFaire Application Objects with Tags/Cats
	*
	* @access private
	* @param int $id Post id to SYNC
	* =====================================================================*/
   ...
   * Add Maker from Application
	...
	* =====================================================================*/
	...
	public function gravityforms_sync_jdb ()
	{
		...
		$result = $mysqli->query("Select  id,form_id from wp_rg_lead WHERE ID =50188");
		...
		while($row = $result->fetch_row())
		{
			...
			$synccontents = json_encode(self::gravityforms_to_jdb_record($entry,$row[0],$row[1]));
			$synccontents = '"'.$mysqli->real_escape_string($synccontents).'"';
